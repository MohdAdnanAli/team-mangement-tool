...
const state = {
  ...
  taskSeq: 21,
  members: [
    {id:'mem-1', name:'Abhijeet', role:'Low-Level Design', capacity:40, avatar: normalizeMemberAvatar('', 'Abhijeet')},
    {id:'mem-2', name:'Pandey', role:'Data Model & Prototyping', capacity:35, avatar: normalizeMemberAvatar('', 'Pandey')},
    {id:'mem-3', name:'Ashutosh', role:'Senior Developer — System Design Lead', capacity:36, avatar: normalizeMemberAvatar('', 'Ashutosh')},
    {id:'mem-4', name:'Jaiswal', role:'Verification & QA', capacity:30, avatar: normalizeMemberAvatar('', 'Jaiswal')},
    {id:'mem-5', name:'Awara Singh', role:'Frontend & Product UI', capacity:34, avatar: normalizeMemberAvatar('', 'Awara Singh')},
    {id:'mem-6', name:'Adnan', role:'Product & Compliance Lead', capacity:20, avatar: normalizeMemberAvatar('', 'Adnan')},
    {id:'mem-7', name:'Shivakashi', role:'Unassigned — Clearance Pending', capacity:8, avatar: normalizeMemberAvatar('', 'Shivakashi')},
  ],
  projects: [
    {id:'proj-1', name:'Core Deal Pipeline', color:'#5B4FCF'},
    {id:'proj-2', name:'OTP & Sealing', color:'#6D5DF6'},
    {id:'proj-3', name:'Bill Generation & Invoicing', color:'#F2B84B'},
    {id:'proj-4', name:'Distribution & Notifications', color:'#5FBF7A'},
    {id:'proj-5', name:'Seller & Buyer UI', color:'#8AA4FF'},
    {id:'proj-6', name:'Security & Compliance', color:'#E8656A'},
  ],
  tasks: [
    {id:'TSK-001', title:'Batch buyer-leg order creation', projectId:'proj-1', assigneeId:'mem-1', status:'done', priority:'high', due:'2026-07-25', hours:10},
    {id:'TSK-002', title:'Redis TTL + rate limiting on public SO routes', projectId:'proj-1', assigneeId:'mem-1', status:'done', priority:'high', due:'2026-07-28', hours:8},
    {id:'TSK-003', title:'Seller-initiated resend-link endpoint', projectId:'proj-1', assigneeId:'mem-1', status:'todo', priority:'med', due:'2026-09-05', hours:6},
    {id:'TSK-004', title:'Register SMS templates with DLT aggregator', projectId:'proj-2', assigneeId:'mem-6', status:'progress', priority:'high', due:'2026-09-10', hours:4},
    {id:'TSK-005', title:'Build OTP request/verify service', projectId:'proj-2', assigneeId:'mem-4', status:'todo', priority:'high', due:'2026-09-15', hours:14},
    {id:'TSK-006', title:'Lock-at-3-attempts + unlock flow', projectId:'proj-2', assigneeId:'mem-4', status:'todo', priority:'med', due:'2026-09-18', hours:6},
    {id:'TSK-007', title:'Build M7 bill generation service', projectId:'proj-3', assigneeId:'mem-1', status:'todo', priority:'high', due:'2026-09-20', hours:16},
    {id:'TSK-008', title:'DB-enforce sequential invoice numbering', projectId:'proj-3', assigneeId:'mem-2', status:'todo', priority:'high', due:'2026-09-12', hours:8},
    {id:'TSK-009', title:'Confirm GST IRN threshold applicability', projectId:'proj-3', assigneeId:'mem-6', status:'todo', priority:'high', due:'2026-09-08', hours:3},
    {id:'TSK-010', title:'Build NotificationService (SES + MSG91)', projectId:'proj-4', assigneeId:'mem-1', status:'progress', priority:'high', due:'2026-09-06', hours:12},
    {id:'TSK-011', title:'Wire SO-link auto-send on generate/resend', projectId:'proj-4', assigneeId:'mem-1', status:'progress', priority:'high', due:'2026-09-04', hours:6},
    {id:'TSK-012', title:'Seller dashboard shell (Next.js)', projectId:'proj-5', assigneeId:'mem-5', status:'todo', priority:'high', due:'2026-09-14', hours:20},
    {id:'TSK-013', title:'Buyer public verification pages', projectId:'proj-5', assigneeId:'mem-5', status:'todo', priority:'high', due:'2026-09-16', hours:18},
    {id:'TSK-014', title:'Wire Seller UI to backend APIs', projectId:'proj-5', assigneeId:'mem-1', status:'todo', priority:'high', due:'2026-09-22', hours:10},
    {id:'TSK-015', title:'DPDP consent flow & legal review', projectId:'proj-6', assigneeId:'mem-6', status:'todo', priority:'high', due:'2026-09-10', hours:8},
    {id:'TSK-016', title:'Encryption-at-rest for GSTIN/phone/payment', projectId:'proj-6', assigneeId:'mem-3', status:'todo', priority:'high', due:'2026-09-12', hours:10},
    {id:'TSK-017', title:'Set budget ceiling & cost-alert thresholds', projectId:'proj-6', assigneeId:'mem-3', status:'todo', priority:'med', due:'2026-09-09', hours:4},
    {id:'TSK-018', title:'Architecture review & final sign-off across all modules', projectId:'proj-6', assigneeId:'mem-3', status:'progress', priority:'high', due:'2026-12-01', hours:20},
    {id:'TSK-019', title:'Complete onboarding: marketing, legal & bank clearance', projectId:'proj-6', assigneeId:'mem-7', status:'todo', priority:'high', due:'2026-09-30', hours:2},
    {id:'TSK-020', title:'Draft storage-scaling design (M14)', projectId:'proj-1', assigneeId:'mem-2', status:'todo', priority:'low', due:'2026-11-01', hours:6},
    {id:'TSK-021', title:'E2E regression suite for OTP + seal flow', projectId:'proj-2', assigneeId:'mem-4', status:'todo', priority:'med', due:'2026-09-20', hours:10},
  ],
  billSeq: 0,
  bills: [
    {
      ...
      lineItems:[
        { description:'Core deal pipeline development', hours:24, rate:2500 },
  ...
  agreements: [
    {
      id: uid('agr'),
      title: 'Kranti — delivery retainer terms',
      party: 'Kranti (client)',
      amount: '₹1,20,000 / month',
      status: 'active',
      dateAgreed: '2026-06-01',
      terms: 'Monthly retainer covers delivery work across the Core Deal Pipeline, OTP, billing, notifications, UI, and compliance streams. Work beyond the agreed scope is invoiced separately at ₹2,500/hr.',
    },
    {
      id: uid('agr'),
      title: 'Kranti — security & compliance scope',
      party: 'Kranti (client)',
      amount: 'Included in delivery scope',
      status: 'active',
      dateAgreed: '2026-08-20',
      terms: 'DPDP consent, encryption safeguards, GST IRN review, and cost-alert controls are tracked as release prerequisites before final architecture sign-off.',
    },
  ],
};
